...
<style>
    ...
    @media (max-width: 640px) {
        ...
        .card-dark > form > div[style] { flex-wrap: wrap !important; }
        .card-dark > form > div[style] input[style*="width:100px"] { width: 100% !important; }
        .card-dark > form > div[style] button { width: 100%; margin-top: 4px; }
    }
</style>
