...
class RolePermission extends Model
{
    ...
    const PAGES = [
        ...
        'admin.qcounts'    => 'ტესტის ზომა',
        'admin.levelrules' => 'დონის ცვლილება',
        'admin.olympiadrules' => 'ოლიმპიადის განრიგი',
        'admin.pointrules' => 'ქულების წესები',
        'admin.achievements' => 'მიღწევები (ადმინი)',
    ...
    const PAGE_ROUTES = [
        ...
        'children'         => ['child.stats', 'child.test.show', 'child.achievements',
                               'child.settings.update', 'child.destroy', 'child.store',
                               'child.link', 'push.remind', 'child.hub', 'child.practice-stats',
                               'child.olympiad-stats'],
        'olympiad'         => ['olympiad.index', 'olympiad.start'],
        'admin.panel'      => ['admin.panel', 'push.send'],
        'admin.grades'     => ['admin.grades.*'],
        'admin.themes'     => ['admin.themes.*'],
        'admin.topics'     => ['admin.topics.*'],
        'admin.questions'  => ['admin.questions.*'],
        'admin.qcounts'    => ['admin.question-counts.*'],
        'admin.levelrules' => ['admin.level-rules.*'],
        'admin.olympiadrules' => ['admin.olympiad-rules.*'],
        'admin.pointrules' => ['admin.point-rules.*'],
